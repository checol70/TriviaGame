...
function begin()
{
    ...
    question5 = new Holder("What game was buried in a dump in New Mexico?", "Street Fighter", "Duck Tales", "E.T.", "The Addams Family", 2,"ET")
    question6 = new Holder("What was the first video game console?", "Atari 2600","Nintendo Entertainment System", "Magnavox Odyssey","Coleco Vision",2,"MagnavoxOdyssey")
    ...
    logAllProperties(question1);
    newQuestion();
}
begin();
$("#correct-shower").text("You have " + amountCorrect+"/"+currentQuestion);
...
function finished()
{
    $("#question").text("You got " + amountCorrect+" out of "+currentQuestion + " Congradulations");
    $("#timer").text("");
    for(var i = 0; i<4; i++)
    {
        $("#answer"+i).text("");
    ...
    $("#correct-shower").text("");
    $("#gif").attr("src","assets/images/Applause.gif")
    $("#gif").show();
}
